# iplayer - AI Assistant Instructions

**Package**: `@apps/iplayer`
**Version**: 0.1.0
**Type**: apps package

## Package Overview

**Description**: BBC iPlayer - UK TV streaming client

**Purpose**: Provide bbc iplayer - uk tv streaming client functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/iplayer` - Main executable
...
1. **Test installation**: `stow iplayer`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D iplayer`
